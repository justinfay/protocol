...
const { expect } = chai;
const {setupSigners,treasuryAddr} = require("./utils/static");
const snowballAddr = "0x60781C2586D68229fde47564546784ab3fACA982";
...
const doLPStrategyTest = (name,assetAddr,snowglobeAddr,strategyAddr,globeABI,stratABI, txnAmt) => {
    ...
    describe("LP Strategy tests for: "+name, async () => {
        ...
        it("Users should earn some money!", async () => {
            ...
            console.log('newAmt: ',newAmt.toString());
        ...
        it("should take no commission when fees not set", async () =>{
            ...
            // Set KeepPNG
            await strategyContract.connect(timelockSigner).setKeepPNG(0);
